...
def get_talk_response(pet_stats, mood):
        client = anthropic.Anthropic()
        ...
        prompt = f"""You are a {mood} pixel pet. Tell the owner one short joke. Stay in character. {personalities[mood]}"""
...
def get_petting_response(pet_stats, mood):
        client = anthropic.Anthropic()
        ...
        prompt = f"""You are a {mood} pixel pet. your owner just pet you affectionatly. Tell the owner one short compliment. Stay in character. {personalities[mood]}"""
